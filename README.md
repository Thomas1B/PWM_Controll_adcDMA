...
The "+1" depends on how you enter values for the ARR during set up, [explanation here]([https://github.com/Thomas1B/STM_basicPWM](https://github.com/Thomas1B/STM_basicPWM/tree/main#setup-example-500-hz-pwm-tim3)).
